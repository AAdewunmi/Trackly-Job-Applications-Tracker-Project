...
def test_user_dashboard_renders_metrics(client) -> None:
    """The dashboard should display metrics generated by the service layer."""
    user = UserFactory()
...
@pytest.mark.django_db
def test_user_dashboard_renders_recent_activity(client) -> None:
    """The dashboard should show recent user-owned applications."""
    user = UserFactory()
    ...
    assert application.company.encode() in response.content
